...
(function (window, document, $, moment) {
    ...
    Plugin.prototype = {
        ...
        initTemplate: function () {
            ...
            this.template =
                ...
                "</button>" +
                '<button class="dtp-btn-cancel btn btn-flat hidden">' +
        ...
        initButtons: function () {
            ...
            this._attachEvent(
                this.$dtpElement.find(".dtp-btn-calendar-ico"),
                "click",
                function () {
            ...
            this._attachEvent(
                this.$dtpElement.find(".dtp-btn-clock-ico"),
                "click",
                function () {
                    if (!$(this).hasClass("disabled")) {
        ...
        initDate: function (d) {
            ...
            if (this.params.monthPicker === false) {
                this.$dtpElement
                    ...
                    .removeClass("hidden");
                this.$dtpElement
                    .find(".dtp-btn-calendar-ico")
                    .addClass("disabled");
                this.$dtpElement
                    .find(".dtp-btn-clock-ico")
    ...
    if (angular && angular.module) {
        angular
            .module("ngDatetimepicker", ["ng"])
            .directive("ngDatetimepicker", [
                function () {
                        ...
                        var $this = {
                            component: $(elem)
                                ...
                                .bootstrapMaterialDatePicker({
                                    ...
                                    cancelText: $scope.ngCancelLabel
                                        ? $scope.ngCancelLabel
                                        : "Cancel",
                                    clearText: $scope.ngCleanLabel
                                        ? $scope.ngCleanLabel
                                        : "Clean",
                                    okText: $scope.ngOkLabel
                                        ? $scope.ngOkLabel
                                        : "OK",
