...
Route::get('/agents/payment-report/{id}', 'Report\AgentPaymentController@index')->name('agents.payment-reports');
...
Route::get('agents-records/{type}', 'Agent\RecordController@index')->name('agents.records');
