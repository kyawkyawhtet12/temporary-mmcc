                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{  $agent->name }}</td>
                                            <td>
                                                {{ $agent->two_limit ? $agent->two_limit->min_amount : 100 }}
                                            </td>
                                            <td>
                                                {{ $agent->two_limit ? $agent->two_limit->max_amount : 100000 }}
                                            </td>
                                            <td>
                                                <a href="javascript:void(0)" class="btn btn-primary edit"
                                                    data-agent={{ $agent->id }}
                                                    data-min={{ $agent->two_limit ? $agent->two_limit->min_amount : 100 }}
                                                    data-max={{ $agent->two_limit ? $agent->two_limit->max_amount : 100000 }}
                                                > Edit </a>
                                            </td>
                                        </tr>
                                        @endforeach
