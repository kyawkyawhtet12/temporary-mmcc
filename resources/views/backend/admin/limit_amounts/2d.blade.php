                                    ...
                                    <tr>
                                        ...
                                        <form id="editable-form" class="editable-form">
                                          <div class="form-group row">
                                            <div class="col-6 col-lg-8 d-flex align-items-center">
                                              <a href="#" id="two_min_amount" data-type="number" data-pk="{{ $amount->id }}">{{ $amount->two_min_amount }}</a>
                                            </div>
                                          </div>
                                        </form>
                                      </td>
                                      <td>
                                        <form id="editable-form" class="editable-form">
                                          <div class="form-group row">
                                            <div class="col-6 col-lg-8 d-flex align-items-center">
                                              <a href="#" id="two_max_amount" data-type="number" data-pk="{{ $amount->id }}">{{ $amount->two_max_amount }}</a>
                                            </div>
                                          </div>
                                        </form>
                                      </td>
