                    ...
                    <div class="card">
                        <div class="card-body">
                          <div class="d-flex justify-content-between mb-3">
                            ...
                            <div>
                              <a class="btn btn-success" href="javascript:void(0)" id="createNewNumber"> Create Lucky Number</a>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-12">
                    ...
                    <form id="productForm" name="productForm" class="form-horizontal">
                       <input type="hidden" name="twodigit_id" id="twodigit_id">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="number" class="form-control" id="twodigit_number" name="twodigit_number" placeholder="Two Digit Number" value="" required="">
                            </div>
                        </div>                        
    ...
    $(function () {
      ...
      var table = $('#two_lucky_numbers').DataTable({
          ...
          columns: [
              ...
              {data: 'lottery_time', name: 'lottery_time'},
      ...
      $('body').on('click', '.editNumber', function () {
        ...
        $.get("{{ route('two_lucky_numbers.index') }}" +'/' + twodigit_id +'/edit', function (data) {
