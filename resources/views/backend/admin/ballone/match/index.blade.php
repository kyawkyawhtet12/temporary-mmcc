          ...
          <div class="modal-body">
              <form id="matchForm" name="matchForm" class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <select class="form-control selectLeague" name="league_id" id="league" style="width: 100%;">
                ...
                <div class="form-group" id="editBetFees">
                  <label for="name" class="col-sm-12 control-label"> လောင်းကြေးပြောင်းလဲမှုရှိပါသလား ? </label>
                  <div class="col-sm-12 d-flex">
                    <div class="mr-3">
                      <input type="checkbox" name="editFee" id="edit_fees" value ="1"> 
                      <label> Yes </label>
                    </div>
                    <div>
                      <input type="checkbox" name="editFee" id="edit_fees" value ="2" checked> 
                      <label> No </label>
                    </div>
                  </div>
                </div>                
                ...
                <div class="form-group editTeams">
                  ...
                  <div class="col-sm-12">
                    <select class="form-control selectHomeTeam" name="home_id" id="home_id" style="width: 100%;">
                ...
                <div class="form-group editTeams">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control selectAwayTeam" name="away_id" id="away_id" style="width: 100%;">
                        
                      </select>
                    </div>
                </div>

                {{-- <div class="form-group editBet">
  ...
  $(document).ready(function() 
  {
    ...
    $('body').on('click', '.deleteMatch', function () {
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url : "{{ route('ballone.match.store') }}"+'/'+ $(this).data("id"),
                    method : 'DELETE',
                }).done(function(res) {                        
                    swal({
                        text: "အောင်မြင်ပါသည်",
    ...
    $('#calculateResult').click(function (e) {
      e.preventDefault();
        ...
        let url =  (type == 'body') ? "{{ route('ballone.calculate.body.result') }}" : "{{ route('ballone.calculate.maung.result') }}";
        // console.log(url)
