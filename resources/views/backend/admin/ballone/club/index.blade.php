            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="clubForm" name="clubForm" class="form-horizontal">
                        ...
                        {{-- <div class="form-group">
                            <label for="name" class="col-sm-12 control-label">Club Code</label>
                            <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-12">
                            <select class="form-control selectLeague" name="league_id" id="league_id" style="width: 100%;">
    ...
    $(document).ready(function() {
      ...
      $('body').on('click', '.editClub', function () {
        ...
        $.get("{{ route('ballone.club.index') }}" +'/' + club_id +'/edit', function (data) {
            ...
            $('#name').val(data.name);
            // $('#code').val(data.code);
            $('#league_id').val(data.league_id).trigger('change');
        })
      });
