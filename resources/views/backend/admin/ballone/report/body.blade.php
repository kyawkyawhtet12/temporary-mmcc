                        ...
                        @if ($dt->body)
                            ...
                            <div class="p-3 mt-4 bg-slate-200 rounded-lg shadow-sm">
                                <div class="d-flex align-items-center justify-content-center gap-2">
                                    ...
                                    <span> {{ get_date_time_format($dt->body->match) }} </span>
                                </div>
                                <div class="mt-2">
                                    <!-- 1 -->
                              ...
                              {{ $dt->body->match->score }}
                                    ...
                                    <div class="w-full d-flex">
                                        ...
                                        <div class="w-40">
                                            <label for="f4-{{ $x }}"
                                                class="bg-white d-block text-center px-1 py-3"
                                                id="{{ $dt->body->type == 'under' ? 'active' : '' }}"><span
                            ...
                            <div class="my-3 d-flex justify-content-between">
                                ...
                                @if ($dt->status == 4)
                                    <p class="w-20 text-center rounded-full bg-danger px-2 py-1 text-white"> Cancel Match
                                    </p>
