            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Maung Setting</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                          <div class="d-flex justify-content-between mb-3">
                            <h4 class="card-title"> Maung Setting </h4>
                            <div>
                                <a class="btn btn-primary" href="javascript:void(0)" id="createLeague"> Add Za</a>
                              </div>
                          </div>
                          <div class="row">
                            <div class="col-12">
            ...
            <div class="modal-body">
                <form id="form" name="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="teams" name="teams" placeholder="Enter Teams Number" value="" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="percent" name="percent" placeholder="Enter Percentage Amount" value="" required="">
                        </div>
                    </div>
