            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Maung Limit</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                          <div class="d-flex justify-content-between mb-3">
                            <h4 class="card-title"> Maung Limit </h4>
                          </div>
                          <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table id="leagues" class="table table-bordered table-striped nowrap">
                                        <thead>
                                            <tr>
                                              <th> No. </th>
                                              <th> Min Teams </th>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="limitForm" name="limitForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="min_amount" name="min_amount" placeholder="Enter Minimum Amount" value="" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="max_amount" name="max_amount" placeholder="Enter Maximum Amount" value="" required="">
                        </div>
                    </div>
...
<script>
  $(document).ready(function() {
    ...
    var table = $('#leagues').DataTable({
      ...
      serverSide: true,
      ajax: {
          url: "{{ route('ballone.maung-limit.index') }}",
          data: function (d) {                
        ...
        columns: [
            ...
            {data: 'min_teams', name: 'min_teams'},
            {data: 'max_teams', name: 'max_teams'},
      ...
      $('body').on('click', '.editLimit', function () {
        
        $.get("{{ route('ballone.maung-limit.get') }}", function (data) {            
            console.log(data);
            $('#modelHeading').html("Update Limit");
            $('#saveBtn').val("edit-league");
            $('#ajaxModel').modal('show');

            $('#min_teams').val(data.min_teams);
            $('#max_teams').val(data.max_teams);
      ...
      $('#saveBtn').click(function (e) {
        e.preventDefault();
          ...
          $.ajax({
            ...
            url: "{{ route('ballone.maung-limit.store') }}",
            type: "POST",
            dataType: 'json',
            success: function (data) {
              $('#limitForm').trigger("reset");
