            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Agent Withdraws Pending</h4>
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                  <div class="d-flex justify-content-end">
                    <a href="{{ route('agent-withdraw.history') }}" class="btn btn-success"> Withdraw History </a>
                  </div>
                </div>
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">Agent Withdraw Pending Lists</h4>
                          <div class="row">
                            <div class="col-12">
...
@push('scripts')
  <script>
    var table = $('#withdrawals').DataTable({
      ...
      serverSide: true,
      ajax: {
        url: "{{ route('agent-withdraw.index') }}",
        data: function (d) {                
    ...
    $(document).on("click", "#withdrawals .btn", function (event) {
