                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="@error('owner') is-invalid @enderror form-control"
                                                    name="owner" minlength="2" type="text"
                                                    value="{{ $provider->owner }}" autocomplete="owner" required />
                                                @error('owner')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="@error('phone_number') is-invalid @enderror form-control"
                                                    ...
                                                    value="{{ $provider->phone_number }}" autocomplete="phone_number"
                                                    required />
                                                @error('phone_number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="@error('image') is-invalid @enderror form-control"
                                                    name="image" minlength="2" type="file" accept="image/*" />
                                                @error('image')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
