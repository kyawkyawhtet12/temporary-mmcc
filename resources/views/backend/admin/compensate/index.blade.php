        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Limit Compensate</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                          <h4 class="card-title">2 Digit Limit Compensate </h4>
                                    ...
                                    <form id="editable-form" class="editable-form">
                                      <div class="form-group row">
                                        <div class="col-6 col-lg-8 d-flex align-items-center">
                                          <a href="#" id="two_compensate" data-type="number" data-pk="{{ $amount->id }}">{{ $amount->compensate }}</a>
                                        </div>
                                      </div>
                                    </form>
                                  </td>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <h4 class="card-title">3 Digit Limit Compensate </h4>
                              <p class="card-description">
                                Click to change<code>Compensate amount</code>
                              </p>
                              <div class="table-responsive">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <form id="editable-form" class="editable-form">
                                          <div class="form-group row">
                                            <div class="col-6 col-lg-8 d-flex align-items-center">
                                              <a href="#" id="three_compensate" data-type="number" data-pk="{{ $amount->id }}">{{ $amount->compensate }}</a>
                                            </div>
                                          </div>
                                        </form>
                                      </td>
