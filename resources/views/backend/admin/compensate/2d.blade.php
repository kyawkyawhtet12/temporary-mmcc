        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">2D Compensate Amount</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">2D Compensate Amount </h4>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{  $agent->name }}</td>
                                            <td>
                                                {{ $agent->two_compensate ? $agent->two_compensate->compensate : 80 }}
                                            </td>
                                            <td>
                                                <a href="javascript:void(0)" class="btn btn-primary edit"
                                                    data-agent={{ $agent->id }}
                                                    data-compensate={{ $agent->two_compensate ? $agent->two_compensate->compensate : 80 }}
                                                > Edit </a>
                                            </td>
                                        </tr>
                                        @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('2d.compensate.amount.post') }}" method="POST" id="form" name="form" class="form-horizontal">
                        @csrf
